...
# Function to predict the label and confidence for a paragraph
def predict_mental_health_with_confidence(text):
    ...
    confidence_dict = {label_map_reversed[i]: score for i, score in enumerate(confidence_scores)}
    return predicted_label, confidence_dict

# Test the model with a long paragraph
paragraph = str(input("Enter your discription"))

# Predict and display results
predicted_label, confidence_dict = predict_mental_health_with_confidence(paragraph)
